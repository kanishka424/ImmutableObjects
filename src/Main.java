...
//        locations.put(5, new Location(5, "You are in the forest"));
        ...
        tempMap.put("S", 4);
        tempMap.put("N", 5);
        locations.put(1, new Location(1, "You are standing at the end of a road before a small brick building",new HashMap<>(tempMap)));
        tempMap.clear();
...
//        locations.get(5).addExit("W", 2);
       ...
       tempMap.put("W", 2);
        ...
        while(true) {
            ...
            //tempMap.remove("S");//if this can be done it is also a vulnerability in our code,Immutibility vice so we have done "Beta" in Location.java
